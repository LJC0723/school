                ...
                <div class="content">
                    ...
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <table class="table" id="communityInformation" style="font-size: small"> </table>

                            <br />
                            <div class="control-group">
                                <div class="controls">
                                    <a class="btn btn-mini btn-info" id="btn-admin-community" href="edmincommunity.jsp">添加</a>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
