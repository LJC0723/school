                    ...
                    <div class="module">
                        ...
                        <div class="module-body">
                            ...
                            <form class="form-horizontal row-fluid">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <div class="input-append">
                                            <input type="text" placeholder="5.000" class="span8" id="purchaseid">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <a class="btn btn-mini btn-info" id="btn-cpurchase" onclick="updatePurchase()">修改</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<script src="js/purchase/updatePurchase.js"></script>
</body>
</html>
